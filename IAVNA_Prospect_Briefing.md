...
| | |
|---|---|
| Company | IAVNA, trading name of International Airport Visual and Navigational Aids Limited |
| Group | Ultimate holding: AGL Advancement Ltd (09828547); intermediate: Air Field Lighting Limited (02264456) owns 100% of the trading company. Brands: IAVNA, ALS, ALT, Richmark |
| What they do | One of the largest global stockists and manufacturers of airfield ground lighting (AGL): LED runway/taxiway/heliport lights, CCRs, cables, control systems, plus design, repair and accredited training |
| Location | Aviation House, Russell Gardens, Wickford, Essex SS11 8BF. Sells globally: 350+ customers, 80+ airports, 50+ countries claimed |
| Websites | iavna.net (corporate/stockist) · airfieldlightingsystems.com (manufactured product brand) · alt-training.com (training academy) |
...
Trading company (01434149), filleted FRS 102 accounts, no P&L disclosed:

| | FY2025 (31 Mar 25) | FY2024 restated |
|---|---|---|
| Net assets | £5,182,713 | £4,739,023 |
| Tangible fixed assets (incl. revalued freehold) | £3,053,918 | £3,079,581 |
| Stock | £2,206,154 | £1,485,355 |
| Debtors | £2,387,338 | £3,035,424 |
| Cash | £231,971 | £135,641 |
| Creditors due beyond one year | £1,067,303 | £802,080 |
| Average employees | 16 | 8 |
...
*Spot check from Ahrefs and public SERPs, 27 to 28 August 2026. Not a rank-tracked audit; no GSC access.*

**Current state of the three sites (Ahrefs, subdomains mode):**

| Site | DR | Ref. domains | Ranking keywords | Est. organic visits/mo |
|---|---|---|---|---|
| airfieldlightingsystems.com | 16 | 466 | 15 | ~110 |
| iavna.net | 2.3 | 471 | 3 | ~1 |
| alt-training.com | 2.5 | 455 | 0 | 0 |
| airfieldlightingsystems.co.uk (former domain) | 30 | 1,955 | 0 | 0 |

**The headline finding: the group's strongest domain has been lost.** airfieldlightingsystems.co.uk (DR 30, ~1,955 referring domains, two decades of aviation links) earned steady traffic until May 2025, fell to zero by August 2025, and now serves "Non GamStop Casinos 2026" content canonicalised to storno.co.uk, a gambling affiliate. The old iavna subdomain on it is dead. Every historic link the group earned now feeds a casino page. The .com replacement started from scratch at DR 16 and has recovered only ~110 visits a month.

**Commercial terms that matter** (GB volume / US volume / global, KD in brackets): airfield lighting 150/200/700 (KD 20-23) · airport lighting 200/900/2,000 (KD 6-25) · runway lights 200/2,000/4,200 (KD 1-2) · runway lighting 100/600/1,300 (KD 3-4) · runway edge lights 60/600/1,400 (KD 2) · taxiway lights 80/500/1,100 (KD 2) · PAPI lights 300/1,500/6,200 (KD 0-1) · heliport lighting 150/150/600 (KD 0) · helipad lighting 150/150/400 (KD 0) · obstruction lighting 150/150/500 (KD 4-10) · constant current regulator 40/100/450 (KD 0) · airfield ground lighting 80/80/400 (KD 4). Training terms (AGL training, ATSEP training, airfield lighting training) are near-zero volume individually; that market is found via the equipment and compliance terms, not searched directly.

**Competitor set in search (not the same as trading rivals):**

| Competitor | Signal |
|---|---|
| ADB Safegate (adbsafegate.com) | DR 54, global OEM, position 1 GB for "airfield lighting"; the one they cannot displace on head terms |
| atg airports (atgairports.com) | DR 29, UK manufacturer, position 2 GB |
| Friars Airfield Solutions (friarsairfield.com + airfieldgroundlighting.com) | DR 2, yet top-5 GB on both domains; proof the niche is winnable with thin authority |
| Mallatite (mallatite.co.uk) | DR 27, traffic-products distributor, page-1 GB |
| Flight Light Inc (flightlight.com / heliportlighting.com) | DR 13-25, owns US heliport SERPs with exact-match satellite site |
| FEC Heliports, Point Lighting, Genesis Lamp | DR 12-26, US heliport/obstruction specialists |
| airport-suppliers.com, airport-technology.com | DR 53-71 directories occupying category SERPs (IAVNA already has a listing) |

**Where the prospect appears:** ALS.com is position 6 GB for "airfield lighting", position 4 GB for "airport lighting", and position 1-2 in US/India/Indonesia for "airfield lighting system(s)": real footholds. Everything else, including every product category above (PAPI, CCRs, heliport, obstruction, cables), earns effectively nothing. iavna.net, the site carrying the deepest stock and the company's actual name, is invisible. alt-training.com ranks for nothing at all. Brand searches do resolve to their own sites.

**AI visibility indicators (spot check):** AI Overviews already appear on most product terms checked (runway lights, runway edge lights, PAPI lights, obstruction lighting, heliport lighting, CCR, airport lighting). These draw on exactly the reference content (spacing, colour, ICAO/FAA requirements) that ALT's instructors are qualified to write and the sites do not publish. No evidence the group is cited; the ingredients AI answers rely on (reviews, comparison content, third-party mentions beyond directories) are largely absent. Recommend running two or three live prompts ("best airfield lighting suppliers UK", "who supplies heliport lighting") before the call.

**What a buyer actually sees:** an airport engineer searching "airfield lighting" in the UK sees ADB Safegate, atg airports, an AI question box, then Friars (a DR-2 site) before ALS at position 6, and never encounters IAVNA by name. A US facilities manager searching "heliport lighting" sees FEC Heliports, Genesis Lamp and two Flight Light properties, with ALS's heliport range nowhere. And anyone who follows one of the group's 1,955 historic .co.uk links, from an old spec sheet, forum post or supplier directory, lands on a casino page.
...
- Live HTTP checks: redirect/canonical inspection of all domain variants, including the casino content and storno.co.uk canonical on airfieldlightingsystems.co.uk
- Web searches: IAVNA company/anniversary coverage, airport-suppliers.com listing, LinkedIn company page reference, RocketReach listing for Keith Spicer
