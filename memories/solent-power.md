...
- **kVA vs kW: SERPs genuinely differ at ≥50kW** (validated 100kVA vs 100kW) → keep both, disambiguate + cross-link twins; **fold ≤25kW into kVA twins** (Google maps 10kw→10kva parent).
